...
# python tools/thesis_compare_images_graph.py --cores 4 --results-dir /home/vscode/results --config-file downsample.json --ref-index 1 --image-loader rgb                  --output-dir graphs/4M_downsample/plots_rgb --metrics flip,hdrvdp3,mse,psnr,ssim
# python tools/thesis_compare_images_graph.py --cores 4 --results-dir /home/vscode/results --config-file downsample.json --ref-index 1 --image-loader rgb_aces_tm_nogamma  --output-dir graphs/4M_downsample/plots_rgb_aces_tm_nogamma
# python tools/thesis_compare_images_graph.py --cores 4 --results-dir /home/vscode/results --config-file downsample.json --ref-index 1 --image-loader rgb_aces_tm          --output-dir graphs/4M_downsample/plots_rgb_aces_tm

# Compare with 4M results (blur)
# python tools/thesis_compare_images_graph.py --cores 4 --results-dir /home/vscode/results --config-file blur.json --ref-index 1 --image-loader rgb                  --output-dir graphs/4M_blur/plots_rgb --metrics flip,hdrvdp3,mse,psnr,ssim
# python tools/thesis_compare_images_graph.py --cores 4 --results-dir /home/vscode/results --config-file blur.json --ref-index 1 --image-loader rgb_aces_tm_nogamma  --output-dir graphs/4M_blur/plots_rgb_aces_tm_nogamma
# python tools/thesis_compare_images_graph.py --cores 4 --results-dir /home/vscode/results --config-file blur.json --ref-index 1 --image-loader rgb_aces_tm          --output-dir graphs/4M_blur/plots_rgb_aces_tm
